...
public class A4Q8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        greetingsDisplayField = new javax.swing.JTextArea();
        ...
        greetingsDisplayField.setEditable(false);
        greetingsDisplayField.setBackground(new java.awt.Color(240, 240, 240));
        greetingsDisplayField.setColumns(20);
        greetingsDisplayField.setFont(new java.awt.Font("MS PGothic", 1, 13)); // NOI18N
        greetingsDisplayField.setRows(5);
        jScrollPane1.setViewportView(greetingsDisplayField);
    ...
    private void sayHelloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sayHelloActionPerformed
        // get the name of user from text box
        String name = nameTextField.getText();
        
        //display saying hello to the user by pressing the button
        greetingsDisplayField.setText("Hello "+ name + " !");
    ...
    private javax.swing.JTextArea greetingsDisplayField;
